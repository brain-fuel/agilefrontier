...
const storageKey = "agilefrontier:v0.2.2";
    ...
    <main className="app-shell">
      <header className="topbar">
        <div className="brand-lockup">
          ...
          <div><strong>Agile Frontier</strong><span>v0.2.2</span></div>
        </div>
      ...
      <footer><span>Agile Frontier v0.2.2</span><span>Plans stay in this browser until you export them.</span></footer>
    </main>
  );
}
